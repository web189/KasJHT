...
function bindTopbarCommon(){
  ...
  // ARISAN OFF SEMENTARA: untuk aktifkan lagi, kembalikan baris di bawah:
  // document.getElementById("mmArisan")?.addEventListener("click", ()=>{ closeMobileMenu(); window.open("https://arisan69.netlify.app/","_blank","noopener"); });
  ...
  // ARISAN OFF SEMENTARA: untuk aktifkan lagi, kembalikan baris di bawah:
  // document.getElementById("dnArisan")?.addEventListener("click", ()=> window.open("https://arisan69.netlify.app/","_blank","noopener"));
  document.getElementById("dnArisan")?.addEventListener("click", ()=>{});
